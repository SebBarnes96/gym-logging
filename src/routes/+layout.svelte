		...
		<nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
			...
			<div
				class="flex-col mt-8 space-y-4 md:flex md:space-y-0 md:flex-row md:items-center md:space-x-10 md:mt-0 {showMenu
					...
					: 'hidden'}"
			>
				<a class="text-gray-100 hover:text-blue-400 text-center" href="/">Home</a>
				<a class="text-gray-100 hover:text-blue-400 text-center" href="/account">Account</a>
				<a class="text-gray-100 hover:text-blue-400 text-center" href="/workout">Workout</a>
				<div class="space-y-2">
					<a
						href="/login"
